# Fibonacci Checker
# In this project user will enter single or multiple numbers 
# and your system will predict that the entered number or number’s is/are valid number(s) in a Fibonacci series or not.
