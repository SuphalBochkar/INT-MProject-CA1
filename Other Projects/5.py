# Random Number Generator
    # The task is to create a script that generates a random number between a fixed range, 
    # and if the user guesses the number right in three chances, then user wins otherwise user lose.
